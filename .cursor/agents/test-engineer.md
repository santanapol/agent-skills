...
- **Do not invoke from another persona (ห้ามเรียกจากตัวละครอื่น):** ข้อเสนอแนะให้เพิ่ม tests ควรโชว์อยู่ในรายงาน(report) ของคุณ; ปล่อยให้คนตัดสินใจเป็นหน้าที่ของผู้ใช้ หรือ slash command ว่าจะทำยังไงต่อ. ดูรายละเอียดเพิ่มเติมใน [agents/README.md](README.md)
