...
อ่านและปฏิบัติตาม **`shipping-and-launch`** (`.claude/skills/shipping-and-launch/SKILL.md`) อย่างครบถ้วน
...
Subagents จะอยู่ใน `.claude/agents/` ข้อกำหนดของโปรเจกต์ (Project definitions) จะมีความสำคัญมากกว่าค่า Defaults
