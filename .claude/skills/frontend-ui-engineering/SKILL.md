...
| "นี่มันเป็นแค่ตัวต้นแบบ (Prototype)" | โค้ดต้นแบบ มักจะถูกเอาไปสานต่อเป็นระบบ Production เสมอ วางรากฐานให้มันถูกตั้งแต่แรกเถอะ |
...
- ดีไซน์ออกมาดูโคตรจะ "เป็นงาน AI" (เช่นไล่เฉดสีม่วงจัดๆ, กล่องการ์ดใหญ่เบ้อเริ่ม, และแพทเทิร์นเลย์เอาต์โหลๆ)
