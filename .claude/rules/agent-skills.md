---
description: Agent Skills lifecycle — map user intent to skills and slash commands in this repo. Use when starting work or choosing a workflow phase.
---

# Agent Skills orchestration

This repo ships production engineering skills for Claude. **Do not improvise workflows** when a matching skill exists — read the skill's `SKILL.md` and follow it completely.
